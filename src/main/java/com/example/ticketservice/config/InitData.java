...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        metricsDepartment1.setDate(new Date());
        ...
        metricsDepartment2.setDate(new Date());
        ...
        metricsDepartment3.setDate(new Date());
        ...
        metricsPriority1.setDate(new Date());
